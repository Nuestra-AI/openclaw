...
async function prepareAgentCommandExecution(
  ...
  // 1. CLI --workspace override (with security boundary check)
  // 2. Subagent spawn inheritance (normalizedSpawned.workspaceDir)
  // 3. Agent config default (resolveAgentWorkspaceDir)
